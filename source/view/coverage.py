...
class ElevationCoverage(QtWidgets.QGraphicsItemGroup):
    ...
    def __init__(self, scene):
        ...
        super(ElevationCoverage, self).__init__()
    ...
    def create(self):
        ...
        if self.scene.rangescale and self.scene.elevationscale and self.scene.gca_elevation_point and (self.scene.azantelev != None):# and self.scene.radarcover_active:
            ...
            self.upper_line_item = QtWidgets.QGraphicsLineItem(upper_line)
            ...
            self.lower_line_item = QtWidgets.QGraphicsLineItem(lower_line)
            ...
            self.azantelev_item = QtWidgets.QGraphicsLineItem(azantelev_line)
...
class AzimuthCoverage(QtWidgets.QGraphicsItemGroup):
    
    def __init__(self, scene):
        super(AzimuthCoverage, self).__init__()
    ...
    def create(self):
        ...
        if self.scene.rangescale and self.scene.azimuthscale and self.scene.gca_azimuth_point:# and self.scene.radarcover_active:
            ...
            self.middle_line_item = QtWidgets.QGraphicsLineItem(middle_line)
